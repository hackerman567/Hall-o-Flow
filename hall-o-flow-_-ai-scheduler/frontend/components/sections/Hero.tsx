...
export const Hero: React.FC<HeroProps> = ({ onWarp }) => {
  ...
  const fullText = "Intelligent Academic Planner.";
      ...
      <div className="relative z-20 text-center px-6 max-w-5xl mx-auto">
        ...
        <Reveal direction="up" delay={0.1}>
          <div className={`inline-flex items-center gap-3 px-4 py-2 rounded-full border bg-opacity-5 backdrop-blur-sm mb-12 transition-colors duration-1000 ${
             ...
             <span className={`text-[10px] font-mono tracking-[0.3em] uppercase ${isRoyal ? 'text-royal-gold' : 'text-neon-cyan'}`}>System Ready</span>
          </div>
        </Reveal>
        ...
        <Reveal delay={0.7} direction="up">
             A master scheduler that organizes your college life. 
             Optimizing your routine through smart algorithms, not manual entry.
        </Reveal>
